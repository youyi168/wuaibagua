...
requirements = python3,kivy==2.2.0,sdl2_image==2.8.4,sdl2_ttf==2.22.0,sdl2_mixer==2.6.0,pyjnius,openssl,libffi
p4a.requirements = kivy==2.2.0
p4a.extra_args = --ignore-setup-py --use-prebuilt-recipes
