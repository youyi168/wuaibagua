...
HEXAGRAM_NAMES = {
    # 乾宫
    '111111': '乾为天', '110111': '天风姤', '000111': '天地否', '000110': '风地观', '000001': '山地剥', '000101': '火地晋', '111101': '火天大有', 
    # 坎宫
    '010010': '坎为水', '011010': '水泽节', '100010': '水雷屯', '101010': '水火既济', '101011': '泽火革', '101100': '雷火丰', '101000': '地火明夷', '010000': '地水师', 
    # 艮宫
    '001001': '艮为山', '010001': '山火贲', '111001': '山天大畜', '011001': '山泽损', '011101': '火泽睽', '011111': '天泽履', '011110': '风泽中孚', '110001': '风山渐', 
    # 震宫
    '100100': '震为雷', '000100': '雷地豫', '010100': '雷水解', '110100': '雷风恒', '110000': '地风升', '110010': '水风井', '110011': '泽风大过', '100011': '泽雷随', 
    # 巽宫
    '110110': '巽为风', '111110': '风天小畜', '101110': '风火家人', '100110': '风雷益', '100111': '天雷无妄', '100101': '火雷噬嗑', '100001': '山雷颐', '001110': '山风蛊', 
    # 离宫
    '101101': '离为火', '001101': '火山旅', '110101': '火风鼎', '010101': '火水未济', '101001': '山水蒙', '010110': '风水涣', '010111': '天水讼', '101111': '天火同人', 
    # 坤宫
    '000000': '坤为地', '100000': '地雷复', '011000': '地泽临', '111000': '地天泰', '111100': '雷天大壮', '111011': '泽天夬', '111010': '水天需', '000010': '水地比', 
    # 兑宫
    '011011': '兑为泽', '010011': '泽水困', '000011': '泽地萃', '001011': '泽山咸', '001010': '水山蹇', '001000': '地山谦', '001100': '雷山小过', '011100': '雷泽归妹', 
}
